...
<head>
    ...
    <style>
        ...
        .status-icon { margin-bottom: 1.5rem; color: #ffc107; }
        ...
        <div class="status-card">
            <div class="status-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
                    <path d="M8.515 1.019A7 7 0 0 0 8 1V0a8 8 0 0 1 .589.022l-.074.997zM12.983 3.017l.792-.61a8 8 0 0 1-.984.984l-.61-.792zM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                    <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"/>
                    <path d="M.56 3.404a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L2.5 5.293l1.646-1.647a.5.5 0 0 1 .708 0zM7 1a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 7 1zm3.293 1.293a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 1 1 .708-.708L9 3.293l1.293-1.293a.5.5 0 0 1 .708 0z"/>
                </svg>
            </div>
            <h4 class="card-title">Payment Pending</h4>
            <p class="card-text">Your transaction is awaiting confirmation. You will be notified once the payment is confirmed.</p>
