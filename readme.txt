...
A PipraPay module to generate multiple, highly customizable payment links.
You can create unlimited links, each with its own settings for fixed prices, custom user-entered amounts, or even simple products with stock control.
== Key Features ==
...
* **Stock & Quantity Control**: Enable a quantity field and manage inventory for fixed-price items.
The link automatically disables when an item is sold out.
...
= 3.0.0 =
* **Feature:** Implemented **Multiple Link Support**.
You can now create unlimited links.
